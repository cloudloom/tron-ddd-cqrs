package com.tracebucket.tron.util;

import com.tracebucket.tron.context.AssemblerConfig;
...
public class AssemblerResolver {
    ...
    private List<String> resolveClasses() {
        ...
        Class assemblerConfig = AssemblerConfig.class;
        if(assemblerConfig.isAnnotationPresent(ComponentScan.class)) {
            ComponentScan componentAnnotation = (ComponentScan) assemblerConfig.getAnnotation(ComponentScan.class);
            String packages[] = componentAnnotation.basePackages();
